...
function MultiCouch(args) {
  ...
  var options = {
    ...
    couchdb_path: args.couchdb_path || win_bin || find_couch_bin(),
...
function find_couch_bin_from_app() {
  // > BASE=`mdfind "kMDItemCFBundleIdentifier == org.apache.couchdb" | head -1` &&  cd "$BASE"/Contents/Resources/couchdbx-core && ./bin/couchdb
